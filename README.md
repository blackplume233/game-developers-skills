...
| [windows-terminal-aesthetics](skills/dev-workflow/windows-terminal-aesthetics/) | 1.0.3 | Windows Terminal 外观调优 + 像素级验证:亚克力/Mica 材质、opacity、无界窗口、文字清晰度,浅色背景下的合成测量(-Screen + 白色底板),并把 settings.json 对照已安装版本的 schema 校验 |
